    ...
    const policyTemplates = {
        ...
        privacy: `
            ...
            <section class="max-w-4xl text-[#1F271B] text-base leading-relaxed">
                ...
                <p class="mb-6">Payment-card details are entered in Razorpay's payment interface and are not stored by this website. We retain records for as long as needed for the service, security, disputes, warranties, tax and other legal obligations. We use scoped sessions, rate limits and restricted TOTP-protected administrative access, but no internet service can promise absolute security. Customer access is identifier-based, so anyone with access to the registered email address or phone number may be able to open that customer account.</p>
