 ...
 * It is one insert with a validation preamble; splitting the two into a
 * service would buy structure this route does not need.
 */
        ...
        try {
            ...
            const { data: inserted, error: insertError } = await supabase
                ...
                .insert([{
                    ...
                    enquirer_phone_number: sanitizedPhone,
