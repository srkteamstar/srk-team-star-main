...
(() => {
    ...
    function mountGallery(hero, entries) {
        ...
        if (slides.length > 1) {
            ...
            // slide happens to be underneath it, light or dark.
            pauseButton.style.cssText = 'position:absolute;right:10px;bottom:10px;z-index:1;display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;padding:0;border:none;border-radius:9999px;background:rgba(18,23,15,.6);color:#fff;';
            const labelPause = () => {
